...
{
	public static final ResourceLocation bigSlotTexture = new ResourceLocation("taxcr", "textures/gui/bigslot.png");
	...
	public void drawForeground(IGuiAccessor gui, int pageRecipeIndex, int mouseX, int mouseY)
	{
		...
		for (int i = 0; i < lines.length; i++)
			gui.getFontRenderer().drawString(lines[i], gui.getLeft() + 35, gui.getTop() + 34 + i * 10, 0xFF000000);
	}
