...
public class DrawableRecipeSmelting extends DrawableRecipe
{
	...
	public static final ResourceLocation smeltingGridTexture = new ResourceLocation("taxcr", "textures/gui/smeltinggrid.png");
	...
	public void draw(IGuiAccessor gui, int pageRecipeIndex, int mouseX, int mouseY)
	{
		if (pageRecipeIndex == 0)
			drawRecipe(gui, gui.getLeft() + 48, gui.getTop() + 14);
		else if (pageRecipeIndex == 1)
			drawRecipe(gui, gui.getLeft() + 48, gui.getTop() + 94);
	}
	...
	{
		if (pageRecipeIndex == 0)
			drawRecipeTooltip(gui, gui.getLeft() + 48, gui.getTop() + 14, mouseX, mouseY);
		else if (pageRecipeIndex == 1)
			drawRecipeTooltip(gui, gui.getLeft() + 48, gui.getTop() + 94, mouseX, mouseY);
	}
	...
	{
		if (pageRecipeIndex == 0)
			clickRecipe(gui, gui.getLeft() + 48, gui.getTop() + 14, mouseX, mouseY, mouseButton);
		else if (pageRecipeIndex == 1)
			clickRecipe(gui, gui.getLeft() + 48, gui.getTop() + 94, mouseX, mouseY, mouseButton);
	}
